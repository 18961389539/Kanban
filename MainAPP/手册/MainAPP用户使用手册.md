...
程序支持简体中文、English、日本語、Português。使用手册目前提供 **中文** 与 **English** 两版；界面为日文或葡文时，按 F1 仍打开英文或中文手册（随语言设置）。
