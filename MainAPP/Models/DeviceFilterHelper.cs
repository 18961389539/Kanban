...
{
    public static void Refresh(ObservableCollection<DeviceFilterItem> items, Kanban.Collector.Core.Data.IDeviceRepository repo)
    {
        items.Clear();
    ...
    /// </summary>
    public static string? FallbackSelected(Kanban.Collector.Core.Data.IDeviceRepository repo, string? currentId)
    {
